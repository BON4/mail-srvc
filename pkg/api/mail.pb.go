...
var file_mail_proto_rawDesc = []byte{
	...
	,
...
var file_mail_proto_depIdxs = []int32{
	0, // 0: MailService.SendEmailOnce:input_type -> CreatedUser
	0, // 1: MailService.ResendEmail:input_type -> CreatedUser
	1, // 2: MailService.VerifyEmail:input_type -> ConfirmUserRequest
	3, // 3: MailService.SendEmailOnce:output_type -> google.protobuf.Empty
	3, // 4: MailService.ResendEmail:output_type -> google.protobuf.Empty
	2, // 5: MailService.VerifyEmail:output_type -> ConfirmUserResponse
...
type MailServiceClient interface {
	SendEmailOnce(ctx context.Context, in *CreatedUser, opts ...grpc.CallOption) (*empty.Empty, error)
	ResendEmail(ctx context.Context, in *CreatedUser, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *mailServiceClient) SendEmailOnce(ctx context.Context, in *CreatedUser, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/MailService/SendEmailOnce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailServiceClient) ResendEmail(ctx context.Context, in *CreatedUser, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/MailService/ResendEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	SendEmailOnce(context.Context, *CreatedUser) (*empty.Empty, error)
	ResendEmail(context.Context, *CreatedUser) (*empty.Empty, error)
...
func (*UnimplementedMailServiceServer) SendEmailOnce(context.Context, *CreatedUser) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendEmailOnce not implemented")
}
func (*UnimplementedMailServiceServer) ResendEmail(context.Context, *CreatedUser) (*empty.Empty, error) {
...
func _MailService_SendEmailOnce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatedUser)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).SendEmailOnce(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MailService/SendEmailOnce",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).SendEmailOnce(ctx, req.(*CreatedUser))
	}
	return interceptor(ctx, in, info, handler)
}

func _MailService_ResendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatedUser)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).ResendEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MailService/ResendEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).ResendEmail(ctx, req.(*CreatedUser))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MailService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendEmailOnce",
			Handler:    _MailService_SendEmailOnce_Handler,
		},
		{
			MethodName: "ResendEmail",
			Handler:    _MailService_ResendEmail_Handler,
		},
		{
